---
title: "Weather Information Preferences in US"
...
## Weather Source Preference by Sex

Finally, here is a breakdown of the `r nrow(sdat)` survey respondents for the `r params$region` region of the US on how they check their daily weather by sex
...
ggplot(sdat, 
  ...
  ggtitle(paste0("Weather Source by Sex: ",
